...
require (
	...
	github.com/aquasecurity/go-git-pr-commenter v0.5.8-beta
...
require (
	...
	github.com/aquasecurity/table v1.5.1 // indirect
	github.com/aquasecurity/trivy-kubernetes v0.3.1-0.20220613131930-79b2cb425b18 // indirect
